    ...
    public class ClientsApiController : ApiController
    {
        ...
        public async Task<IHttpActionResult> CreateBooking()
        {
            ...
            try
            {
                ...
                return Ok("Spot Booking has been successfully created");
            }
            catch (Exception)
            {
                return BadRequest("Failed to create spot booking");
            }
        }

        // Update Booking
        [HttpPut]
        [Route("update-booking/{clientId}")]
        public async Task<IHttpActionResult> UpdateBooking(int clientId)
        {
            if (!Request.Content.IsMimeMultipartContent())
            {
                return BadRequest("Unsupported media type.");
            ...
            try
            {
                ...
                return Ok("Spot Booking has been successfully updated");
            }
            catch (Exception)
            {
                return BadRequest("Failed to update Spot Booking");
            }
        }
        ...
        public async Task<IHttpActionResult> DeleteBooking(int id)
        {
            ...
            {
                return BadRequest("Failed to delete Spot Booking");
            }

            return Ok("Spot Booking been successfully deleted");
        }
